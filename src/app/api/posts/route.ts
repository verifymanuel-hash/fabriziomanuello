  ...
  try {
    ...
    try {
      ...
      return NextResponse.json(
        { error: 'Invalid JSON or request too large. Try compressing your images.' },
        { status: 400 }
      )
    }
    ...
    if (!title || !slug || !category || !content) {
      return NextResponse.json(
        { error: `Missing required fields. Title: ${!!title}, Slug: ${!!slug}, Category: ${!!category}, Content: ${!!content}` },
        { status: 400 }
      )
    }
